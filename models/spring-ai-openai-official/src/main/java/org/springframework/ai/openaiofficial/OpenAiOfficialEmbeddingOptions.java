...
public class OpenAiOfficialEmbeddingOptions implements EmbeddingOptions {
	...
	/**
	 * The model name used. When using Azure AI Foundry, this is also used as the default deployment name.
	 */
	private String model;

	/**
	 * The deployment name as defined in Azure AI Foundry.
	 * On Azure AI Foundry, the default deployment name is the same as the model name.
	 * When using OpenAI directly, this value isn't used.
	 */
